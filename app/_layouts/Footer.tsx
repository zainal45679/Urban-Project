...
const Footer = () => {
  return (
    <>
      <div className="px-15 absolute w-full max-lg:hidden">
        ...
        <div className="bg-[#393939] p-10 flex justify-between w-full rounded-t-[50] z-10 gap-10 pr-20">
          <div className="w-[40%] flex flex-col gap-3 ">
            ...
            <div className="text-lg font-medium">
              ...
              platform. With a wide range of high-quality options from top
      ...
      <div className="px-6 py-6 bg-[#393939] text-white lg:hidden flex flex-col gap-6">
        <div className="flex justify-center">
          <Image src={logo} alt="logo" height={60} className="object-contain" />
        </div>

        <div className="flex gap-5">
          <div className="flex w-[48%] max-md:hidden flex-col gap-1 pl-5 lg:hidden">
            <div className="text-xl font-semibold">Order Online</div>
